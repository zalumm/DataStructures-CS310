...
*	returns false and aborts the insertion if the list is full. 
    */ 
    ...
    /* Adds the Object obj to the end of list and returns true if the list is not full.     *  returns false and aborts the insertion if the list is full.   
    */ 
...
*	it, null otherwise. The ordering of the list is preserved.  The list may contain      *  duplicate elements.  This method removes and returns the first matching element     *  found when traversing the list from first position. 
...
*	element was located. 
    ...
    *  In the case of duplicates, this method returns the element closest to front.     *  The list is not modified. 
    */ 
    public E find(E obj);        
